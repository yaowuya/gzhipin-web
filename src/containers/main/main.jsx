        ...
        return (
            <div>
                ...
                <Switch>
                    ...
                    <Route key='/laobaninfo' path='/laobaninfo' component={LaobanInfo}/>
                    <Route key='/dasheninfo' path='/dasheninfo' component={DashenInfo}/>
...
1. 实现自动登陆:
  1. componentDidMount()
    登陆过(cookie中有userid), 但没有有登陆(redux管理的user中没有_id,
    可能是在浏览器窗口登陆了，但是打开新的窗口，用链接直接访问页面，这种情况下user就没有_id) 发请求获取对应的user:
  2. render()
